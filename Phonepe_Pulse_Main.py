...
icon = Image.open("F:\CAPSTONE PROJECT\github_copy\Phonepe_Pulse_Data_Visualization\Data\ICN.png")
st.set_page_config(page_title= "Phonepe Pulse Data Visualization | By Guru Rathinam",
                   page_icon= icon,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This dashboard app is created by *Guru Rathinam*!
...
# MENU 1 - HOME
if selected == "Home":
    st.image("F:\CAPSTONE PROJECT\github_copy\Phonepe_Pulse_Data_Visualization\Data\img.png")
    ...
    with col2:
        st.image("F:\CAPSTONE PROJECT\github_copy\Phonepe_Pulse_Data_Visualization\Data\home.png")
...
# EXPLORE DATA - TRANSACTIONS
    if Type == "Transactions":
        ...
        with col1:
            ...
            df2 = pd.read_csv('F:\CAPSTONE PROJECT\github_copy\Phonepe_Pulse_Data_Visualization\Data\Statenames.csv')
            df1.State = df2
...
if selected == "About":
    ...
    with col2:
        ...
        st.write(" ")
        st.write(" ")
        st.image("F:\CAPSTONE PROJECT\github_copy\Phonepe_Pulse_Data_Visualization\Data\Pulseimg.jpg")